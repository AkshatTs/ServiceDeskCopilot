...
The Master Spec is the source of truth. This prompt defines how you must operate while implementing it.
...
12 RAG
13 Status
14 Semantic Kernel/function calling
15 MCP
16 Incident draft
17 Reviewer
18 Approval
19 Ticketing
20 Azure AI Foundry Agents + Application Integration
21 Streaming
...
- integration tests for chat/search/tools/MCP
- prompt evaluation: ≥15 golden + 5 adversarial
- API authentication/authorization/validation/streaming/cancellation/errors
- performance: 5 concurrent requests + one long request
